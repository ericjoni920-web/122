...
// Extend JSX namespace to support <model-viewer> custom element in TypeScript
declare global {
  namespace JSX {
        ...
        <div className="container relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24 py-8 md:py-12">
              ...
              <div className="w-full md:w-[60%] lg:w-[65%] h-[300px] sm:h-[400px] md:h-[450px] lg:h-[550px] relative order-2 md:order-1 flex items-center justify-center">
                <model-viewer
                  class="w-full h-full outline-none drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
                  src="https://cdn.shopify.com/3d/models/d44860a0b5779e8f/laptop_dell_xps.glb"
                  alt="3D Laptop Model"
                  auto-rotate
                  camera-controls
                  shadow-intensity="2"
